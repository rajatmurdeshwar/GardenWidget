package com.rnm.test.gardenwidget.provider;

import android.content.Context;
import android.database.sqlite.SQLiteDatabase;
import android.database.sqlite.SQLiteOpenHelper;

import com.rnm.test.gardenwidget.provider.PlantContract.PlantEntry;
...
public class PlantDbHelper extends SQLiteOpenHelper {
    ...
    // The database name
    private static final String DATABASE_NAME = "gardenwidget.db";
